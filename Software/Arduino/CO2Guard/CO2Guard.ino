/* 
 * CO2 Guard Elektor V2.1
 * Florian Schäffer
 * Mathias Claußen
 * adaptiert für Arduino IDE: Hans Schneider 2022-02-03
 * 
 * renamed variable thinkspeak -> thingspeak
 * 
 * Board: LOLIN(WEMOS) D1 R2 & mini
 * ESP8266
 * 
 * Don't forget to upload data using ESP8266 LittleFS Data Upload plugin
 * 
 */
...
ALARM BEEP(ALARMTHRESHOLD,HYSTERESE,PWMVALUE,BUZZERPIN);
